...
class Printing extends Model
{
	...
	public static function getTodayCash()
	{
		...
		$query = "select SUM(printing_price_history.price) as summ from printing_sale
					JOIN printing_price_history ON printing_price_history.printing_id = printing_sale.printing_id AND printing_sale.datetime >= printing_price_history.datetime_from AND (printing_sale.datetime < printing_price_history.datetime_to OR printing_price_history.datetime_to IS NULL)
 AND printing_sale.department_id = printing_price_history.department_id
WHERE printing_sale.datetime::date = now()::date AND printing_sale.department_id = $department_id";
